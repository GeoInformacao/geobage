#' Areas intermediate the municipality of Bage
#'
#' Function returns the intermediate region in which the municipality of Bage is inserted. Intermediate Geographic
...
read_intermediate_region_bg <- function(){
  objeto <- geobr::read_intermediate_region(code_intermediate = 4302)
  objeto
}
